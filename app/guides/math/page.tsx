...
export default function MathGuidesPage() {
  return (
        ...
        <section className="bg-slate-50 px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg text-slate-600">
              Master everyday math with our comprehensive guides. From percentage
              calculations to date arithmetic, learn practical skills you can use
              every day.
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-6xl">
            <div className="mb-8 flex items-center gap-2">
              ...
              <h2 className="text-xl font-bold text-slate-900">
                Featured Math Guides ({guides.length})
              </h2>
            </div>
        ...
        <section className="border-t border-slate-200 bg-slate-50 px-4 py-16 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-6 text-slate-600">
              Try our free math calculators to apply your new skills.
            </p>
            <Link
              href="/tools/math"
